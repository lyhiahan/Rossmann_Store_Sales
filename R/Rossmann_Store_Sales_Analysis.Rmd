...
## 4.6 Biểu đồ nâng cao & Phân tích Chiến lược

### 4.6.1 Phân phối Doanh số và Khách hàng
...
### 4.6.2 Kiểm định Phân phối chuẩn và Biến đổi Log-scale
...
### 4.6.3 Xu hướng Doanh số theo Thời gian (Time Series Trend)
...
### 4.6.4 Phân tích Biến động theo Tháng và Ngày trong tuần
...
### 4.6.5 Tác động của Ngày lễ Quốc gia và Kỳ nghỉ học
...
### 4.6.6 Phân phối doanh số theo Assortment
...
### 4.6.7 Doanh thu trung bình trên mỗi khách hàng theo loại cửa hàng
...
### 4.6.8 Tác động của Khuyến mãi đến Doanh số theo Store Type
...
### 4.6.9 Tỷ lệ Giao dịch Ngoại lai theo từng Cửa hàng
...
### 4.6.11 Ảnh hưởng thời gian hoạt động của đối thủ cạnh tranh đến Doanh số
...
### 4.6.12 Tỷ lệ Outlier theo Tháng
...
### 4.6.13 Hiệu quả Khuyến mãi theo Ngày trong tuần (Dumbbell Chart)
...
### 4.6.14 Hiệu ứng Cộng hưởng giữa Khuyến mãi Định kỳ và Khuyến mãi Dài hạn
...
### 4.6.15 Phân tích Tăng trưởng Tháng-so-với-Tháng (Waterfall Chart)
...
### 4.6.16 Phân tích Pareto — Top cửa hàng đóng góp 80% tổng doanh thu
...
### 4.6.17 Lollipop Chart — Xếp hạng Hiệu suất 50 Cửa hàng
...
### 4.6.18 Toàn cảnh Hiệu suất 50 Cửa hàng Rossmann — Biểu đồ Bong bóng Đa chiều
...
### 4.6.19 Ma trận Chiến lược BCG — Phân loại 50 Cửa hàng
