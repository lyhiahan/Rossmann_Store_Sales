...
# |  KHÔNG chỉnh sửa nếu không có sự đồng ý của trưởng nhóm
...
required_packages <- c(
  ...
  # Trực quan hóa
  "ggplot2", "plotly", "corrplot", "ggcorrplot", "scales", "gridExtra", "RColorBrewer","rpart","rpart.plot",
  # Mô hình hóa 
...
# KHÔNG tính median/IQR bên trong (tránh Data Leakage)
...
cat("   clean_rossmann() hỗ trợ cả train.csv (has_sales=TRUE) và test.csv (has_sales=FALSE)\n")
cat("   sales_per_customer: CHỈ cho EDA, KHÔNG dùng trong model\n")
```

---

# 3. Exploratory Data Analysis (EDA) & Data Pipeline
