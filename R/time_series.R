...
cat("[Thành Tài] Trung bình doanh số/ngày:",
...
cat("[Thành Tài] ts object: length =", length(ts_daily),
...
cat("[Thành Tài] Đã lưu: output/figures/p_ts_decomposition.png\n")
...
cat("[Thành Tài] TS Train:", length(ts_train), "ngày (",
    round(length(ts_train) / n_ts * 100, 1), "%)\n")
cat("[Thành Tài] TS Test :", length(ts_test), "ngày (",
...
cat("[Thành Tài] Đã lưu: output/figures/p_ts_arima_forecast.png\n")
...
ggsave(here("output", "figures", "p_ts_ets_forecast.png"), p_ets,
       width = 10, height = 5, dpi = 150)
cat("[Thành Tài] Đã lưu: output/figures/p_ts_ets_forecast.png\n")
...
ggsave(here("output", "figures", "p_ts_comparison.png"), p_ts_compare,
       width = 10, height = 5, dpi = 150)
cat("[Thành Tài] Đã lưu: output/figures/p_ts_comparison.png\n")
...
cat("[Thành Tài] ✅ Time Series Analysis hoàn tất!\n")
